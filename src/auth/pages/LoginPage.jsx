...
export const LoginPage = () => {
  ...
  const isAuthenticating = useMemo(() => status === 'checking', [status]); // Retorna un booleano

  const onSubmit = (event) => {
    event.preventDefault();
    dispatch( startLoginWithEmailPassword( {email, password} ) ); //Sí esta mandando bien los parametros
  }
