        ...
        <Grid container>
          ...
          <Grid item xs={12} sx={{ mt: 2 }}>
            <TextField
              ...
              type="text"
              placeholer='Antonio De León'
              fullWidth
              name="displayName"
              value={displayName}
              onChange={handleInputChange}
              error={ !!displayNameValid && formSubmitted } // "displayNameValid" es un mensaje de error ó un null, si existe el mensaje de error va a marcar un "true"
              helperText={displayNameValid} // Con null ya no se muestra el mensaje
